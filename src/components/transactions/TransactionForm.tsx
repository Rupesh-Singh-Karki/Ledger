        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <Input
              ...
              className="rounded-full bg-input border-border"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.type} onValueChange={(v: 'income' | 'expense') => handleTypeChange(v)}>
                <SelectTrigger className="rounded-full bg-input border-border" id="txn-type">
                  <SelectValue />
                </SelectTrigger>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="space-y-2">
              ...
              <Select value={formData.category} onValueChange={(v: string) => setFormData((prev) => ({ ...prev, category: v }))}>
                <SelectTrigger className="rounded-full bg-input border-border" id="txn-category">
            ...
            <div className="space-y-2">
              ...
              <Select value={formData.status} onValueChange={(v: 'completed' | 'pending') => setFormData((prev) => ({ ...prev, status: v }))}>
                <SelectTrigger className="rounded-full bg-input border-border" id="txn-status">
                  <SelectValue />
                </SelectTrigger>
                <SelectContent className="rounded-xl">
